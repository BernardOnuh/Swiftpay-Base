...
const PaymentReceipt = ({
    ...
    const downloadReceipt = () => {
      ...
      if(!element) {
          console.log("Error: Invalid element reference");
          return;
      }
        ...
        <div>
          ...
          {isOpen && (
            <div className="fixed inset-0 flex items-center justify-center z-50">
              <div ref={receiptRef} className="bg-white p-8 max-w-md w-full rounded-lg shadow-lg relative">
                <button
                ...
                <table className="min-w-full">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="py-2 px-4">
                        <p className="text-sm">{paymentType} Payment</p>
                      </td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4">
                ...
                <div className="flex justify-end space-x-4 mt-6">
                  ...
                  <button className="px-4 py-2 border border-[#4318FF] text-gray-600 rounded-lg hover:bg-blue-600">
                    <a
                      href={`https://testnet.flowdiver.io/tx/${transactionId}`}
                      target="_blank"
